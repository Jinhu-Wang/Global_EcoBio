...
**JSON File**: Place the JSON file containing tile metadata (tile boundaries, URLs, etc.) in data/0_json/DSM/kaartbladindex.json. [json](https://service.pdok.nl/rws/ahn/atom/dsm_05m.xml)
