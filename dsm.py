...
json_path = 'data/0_json/DSM/kaartbladindex.json'
shapefile_path = 'data/1_shpfiles/AWD_sampling_area.shp'
download_dir = 'data/2_downloaded_geotiff/DSM'
output_clipped_dir = 'data/3_clipped/DSM'
output_merged_dir = 'data/4_merged/DSM'
